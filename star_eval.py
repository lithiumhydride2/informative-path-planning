...
maxima_files = [
    prefix + "mes_plumes/" + max_filename,
    prefix + "mes_lawn/" + max_filename,
]

sample_files = [
    prefix + "mes_plumes/" + samp_filename,
...
for i, (label, max_file, samp_file) in enumerate(
    zip(labels, maxima_files, sample_files)
):
